...
using TaskerDemo.MVVM.ViewModels;

namespace TaskerDemo.MVVM.Views;
...
public partial class NewTaskView : ContentPage
{
    ...
    private async void AddCategoryClicked(object sender, EventArgs e)
    {
        ...
        string category = await DisplayPromptAsync("New Category", "Write the new category", maxLength: 15, keyboard: Keyboard.Text);
